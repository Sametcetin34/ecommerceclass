    ...
    uploadTask.on('state_changed',
      ...
      () => {
        ...
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          ...
          toast.success("Image uploader successfully.")
        });
      }
    );
  };
 ...
 <div className={styles.product}>
      ...
      <Card cardClass={styles.card}>
        <form onSubmit={detectForm(id,addProduct,editProduct)}>
          ...
          <input
            type='text' placeholder='Product name' required name="name" value={product.name} onChange={(e) => handleInputChange(e)} />
          ...
          <textarea name='desc' value={product.desc} onChange={(e) => handleInputChange(e)} cols="30" rows="10" />
